...
insert into RESERVATION (STOCK_ID, RESERVATION_DATE_TIME, ITEMS_RESERVED, STATUS) values (1, CURRENT_TIMESTAMP(), 3, 'OPEN');
insert into RESERVATION (STOCK_ID, RESERVATION_DATE_TIME, ITEMS_RESERVED, STATUS) values (1, CURRENT_TIMESTAMP(), 5, 'OPEN');
